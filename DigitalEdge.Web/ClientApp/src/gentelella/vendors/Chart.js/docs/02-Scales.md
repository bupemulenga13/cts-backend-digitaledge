...
The time scale is used to display times and dates. It can only be placed on the X axis. When facility its ticks, it will automatically calculate the most comfortable unit base on the size of the scale.
